...
class SiteBuildTests(unittest.TestCase):
    ...
    def test_homepage_uses_latest_published_daily(self):
        ...
        self.assertIn("2026-08-02", home)
        self.assertIn("beauty-daily-20260802", home)
    ...
    def test_github_pages_build_uses_repository_base_path_and_keeps_home_images(self):
        ...
        self.assertTrue(
            (self.output / "assets/img-03-mac-lipgloss-xoxo.png").is_file()
        )
    ...
    def test_manifest_sources_exist(self):
        ...
        self.assertEqual(len(reports), 27)
